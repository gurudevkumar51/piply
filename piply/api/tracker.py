...
class ExecutionTracker:
    ...
    def complete_task(self, task_name: str, success: bool, result: Any = None, error: str = None):
    ...
    def fail_task(self, task_name: str, error: str):
        ...
        self.complete_task(task_name, False, error=error)

    def log(self, level: str, message: str, logger_name: str = None, **extra):
        """Capture a log entry."""
        with self._log_lock:
